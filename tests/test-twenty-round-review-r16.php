...
$checks = array(
    ...
    'pdf-library-foundation-12/includes/class-pldr-rights.php' => array('pldr_case_event_atomic','pldr_case_decision_event_atomic','pldr_appeal_event_atomic','pldr_publish_event_atomic','pldr_pack_event_atomic','pldr_rights_event_atomic'),
    'pdf-library-foundation-12/includes/class-pldr-access.php' => array('pldr_policy_event_atomic'),
    'pdf-library-foundation-12/includes/class-pldr-reader.php' => array('pldr_progress_event_atomic'),
    ...
    'pdf-library-foundation-12/includes/class-pldr-future-rooms.php' => array('pldr_room_event_atomic','atomic-event-persistence-failed'),
