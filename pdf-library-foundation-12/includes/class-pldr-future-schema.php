...
final class PLDR_Future_Schema {
    ...
    public static function maybe_upgrade(): bool {
        ...
        if ($version_current && $revision_current) {
            ...
            if (get_transient($health_key)) return true;
    ...
    public static function is_current(): bool {
        return (string)get_option('pldr_future_db_version','')===self::DB_VERSION
            && (string)get_option('pldr_future_schema_revision','')===self::SCHEMA_REVISION
            && !get_option('pldr_future_schema_error');
    }
